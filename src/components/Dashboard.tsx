...
const COLORS = ['#059669', '#DC2626', '#2563EB', '#7C3AED', '#EA580C', '#DB2777']
        ...
        .reduce((acc: any[], transaction: any) => {
          ...
          if (existing) {
            ...
            acc.push({
              ...
              color: transaction.categories?.color || COLORS[acc.length % COLORS.length]
            })
          }
  ...
  return (
    <div className="p-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-2xl font-bold ${
                data.monthlyIncome - data.monthlyExpenses >= 0 ? 'text-green-600' : 'text-red-600'
              }`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        {/* Accounts Overview */}
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Suas Contas</h3>
          <div className="space-y-3">
