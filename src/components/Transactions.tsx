...
import { Plus, ArrowUpRight, ArrowDownRight, Edit2, Trash2, Filter, Calendar } from 'lucide-react'
    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-gray-600 mt-2">Registre suas receitas e despesas</p>
        </div>
        <button
          onClick={openModal}
      ...
      <div className="space-y-4">
        {filteredTransactions.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Registre seu primeiro lançamento para começar</p>
            <button
              onClick={openModal}
          ...
          filteredTransactions.map((transaction) => (
            <div key={transaction.id} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
          ...
          <div className="bg-white rounded-xl max-w-md w-full p-6 my-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              ...
              <div>
                ...
                <select
                  {...register('account_id', { required: 'Conta é obrigatória' })}
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                {errors.account_id && (
                  <p className="text-red-600 text-sm mt-1">{errors.account_id.message}</p>
                )}
              </div>
              ...
              <div className="space-y-2">
                <label className="flex items-center">
                  ...
                  />
                  <span className="ml-2 text-sm text-gray-700">Lançamento recorrente</span>
                </label>
              ...
              <div className="flex space-x-3 pt-4">
                ...
                >
                  {submitting ? 'Salvando...' : (editingTransaction ? 'Atualizar' : 'Criar')}
                </button>
              </div>
            </form>
          </div>
